...
public abstract class AlienMain extends JPanel implements AlienCommonClass, MouseListener {
	...
	public AlienMain(BufferedImage[] frames,int frameLivingLimit, int x, int y) {
	...
	public AlienMain(String filePath, int row, int col, int frameLivingLimit, int x, int y) 
			throws IOException {
